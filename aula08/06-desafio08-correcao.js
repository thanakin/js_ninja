/*
Declare uma variável chamada `sum` e atribua a ela uma função chamada `calculateSum`. 
...
var value1 = 1;
var value2 = 3;
console.log('A soma de '+ value1 +' e '+ value2 +' é igual a '+ sum(value1, value2) +'.'); //A soma de 1 e 3 é igual a 4.
...
function calculator(operation){
    return function calculadora(x, y){
        var result;
        switch(operation){
            case '+':
                result = x + y;
        ...
        return console.log("Resultado da operação: "+ x +" "+ operation +" "+ y +" = "+ result +".");
    };
}
...
/*
Agora, declare algumas variáveis com os nomes `subtraction`, `multiplication`, `division` e `mod`, 
e atribua a elas a função `calculator`, passando o operador correto por parâmetro para cada uma delas.
*/
...
*/
console.log( subtraction( 1, 2 ) ); //Resultado da operação: 1 - 2 = -1.
