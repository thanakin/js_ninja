...
teams.showTeamPosition = function (position) {
    ...
    switch(position){
        case 1:
            valor = 'O time que está em '+ position +'º lugar é o '+ teams[position - 1 ]+'.';
        break;
        case 2:
            valor = 'O time que está em '+ position +'º lugar é o '+ teams[position - 1 ]+'.';
        break;
        ...
        break;
        default:
            valor = 'Não temos a informação do time que está nessa posição.';
    }
    return valor;
};
...
function convertToHex(cor){
    switch(cor){
        case 'vermelho':
            retorno = 'O hexadecimal para a cor '+ cor +' é #FF0000.';
        break;
        case 'laranja':
            retorno = 'O hexadecimal para a cor '+ cor +' é #FFA500.';
        break;
        case 'amarelo':
            retorno = 'O hexadecimal para a cor '+ cor +' é #FFFF00.';
        break;
        case 'azul':
            retorno = 'O hexadecimal para a cor '+ cor +' é #0000FF.';
        break;
        case 'verde':
            retorno = 'O hexadecimal para a cor '+ cor +' é #008000.';
        break;
        default:
            retorno = 'Não temos o equivalente hexadecimal para '+ cor +'.';
    }
    return retorno;
};
