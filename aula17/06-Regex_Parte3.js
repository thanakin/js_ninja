 ...
 * 
 *      Termos
 *      \w: caracecteres alfanumericos a-z A-Z 0-9 e _
 *      \d: numeros (digits)
 * 
...
(function(){
    ...
    console.log( '\n', texto.replace( /(d)(e)/g, '--$2' ) );
    console.log( '\n', texto.replace( /(d)(e)/g, function(){
        console.log('ARGUMENTS', arguments);
    } ) );
    console.log( '\n', texto.replace( /(d)(e)/g, function(capturaotal, d, e){
        return (d + e).toUpperCase();
    } ) );

    console.log ( '\n', 'Thanakin'.replace( /(\w)/g, function(capturaTotal, letra){
        return letra.toUpperCase();
    }) );

    console.log ( '\n', 'Thanakin'.replace( /(\w)(\w)/g, function(capturaTotal, letra1, letra2){
