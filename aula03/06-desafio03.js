...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Thanakin Skywalker!'
...
pessoa.apresentacao = function(){
    ...
    frase = frase + pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade;
    ...
    frase = frase + ', '+ pessoa.altura + 'm, meu peso é ' + pessoa.peso + 'kg e, só hoje, eu já caminhei ' + pessoa.caminhouQuantosMetros;
...
// Agora, apresente-se ;)
pessoa.apresentacao(); //Olá, eu sou o Thanakin Skywalker, tenho 15 anos, 1.71m, meu peso é 85kg e, só hoje , eu já caminhei 9metros!